            ...
            <div className="container mx-auto max-w-7xl px-4 sm:px-6">
                <div className="mb-12 animate-on-scroll fade-in-up">
                    <h1 className="text-4xl font-bold text-[#0E2A47]">
                        <EditableText as="span" configKey="portal.welcome" defaultValue="Welcome, " />{patientData.name}
                    </h1>
                    <EditableText
                      as="p"
                      configKey="portal.subtitle"
                      defaultValue="Here is your personal health dashboard."
