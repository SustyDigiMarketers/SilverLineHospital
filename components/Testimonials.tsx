        ...
        <section id="testimonials" className="py-24 bg-white">
            <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="relative h-[450px] overflow-hidden group [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]">
                        <div className="flex flex-col animate-marquee-y group-hover:[animation-play-state:paused]">
                            ...
                            {testimonials.length > 0 && [...testimonials, ...testimonials].map((testimonial: any, index: number) => (
                                <div key={index} className="bg-white rounded-xl shadow-lg p-6 mb-6 flex-shrink-0 border hover:border-[#00B5A5] transition-colors duration-300">
                                    <div className="mb-4">
