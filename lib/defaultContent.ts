...
export const defaultContent = {
  ...
  about: {
    ...
    team: {
      ...
      members: [
        { name: 'Dr. Senthil Kumar', role: 'Chief Cardiologist', image: 'imagePaths.doctors.senthilkumar' },
        { name: 'Dr. Hemalatha', role: 'Senior Obstetrician', image: 'imagePaths.doctors.hemalatha' },
        { name: 'Dr. Sivapragash', role: 'Head of Oncology', image: 'imagePaths.doctors.sivapragash' }
      ]
    },
    sideBySide: {
